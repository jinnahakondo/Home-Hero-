...
const ErrorPage = () => {
    ...
    return (
        ...
        <section className="relative z-10 bg-primary min-h-screen grid place-items-center">
                ...
                <div className="-mx-4 flex">
                    <div className="w-full px-4">
                        <div className="mx-auto max-w-[400px] p-4 text-center">
                            ...
                            <h4 className="mb-3 md:text-xl font-semibold leading-tight text-white">
                                Oops! That page can’t be found
                            </h4>
                            <p className="mb-8 md:text-lg text-white">
